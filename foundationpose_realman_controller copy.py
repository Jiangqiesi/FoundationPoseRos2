...
class FoundationPoseRealmanController(Node):
    def __init__(self, object_ids, robot_ip="192.168.0.17", auto_move=False, offset_z=0.16, enable_grasp=True, lift_height=0.2):
    ...
    def convert_pose_to_realman_format(self, pose_msg):
        ...
        z = pose_msg.pose.position.z + self.offset_z  # 添加Z方向偏移
    ...
    def grasp_and_lift_sequence(self, object_id, grasp_pose):
        ...
        try:
            ...
            self.rm_controller.set_gripper(-0.8)  # 负值表示闭合
